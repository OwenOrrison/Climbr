...
export default class PRGChat extends Component {
  constructor(props) {
    super(props);
    this.state = {
        chatMessage: "",
    ...
    this.getPRG = this.getPRG.bind(this);
  }
  ...
  getPRG = () => {
    fetch('http://192.168.0.7:3000/prg/', {
        method: 'GET'
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Text style={styles.title}>Portland Rock Gym</Text>
        <TextInput
