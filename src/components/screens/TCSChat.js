...
export default class TCSChat extends Component {
  constructor(props) {
    super(props);
    this.state = {
        chatMessage: "",
    ...
    this.getTCS = this.getTCS.bind(this);
  }
  ...
  getTCS = () => {
    fetch('http://192.168.0.7:3000/tcs/', {
        method: 'GET'
    ...
    return (
     <View
      ...
      >
        ...
        <Text style={styles.title}>The Circuit - South</Text>
        <TextInput
