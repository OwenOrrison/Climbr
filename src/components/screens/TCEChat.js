...
export default class TGEChat extends Component {
  constructor(props) {
    super(props);
    this.state = {
        chatMessage: "",
    ...
    this.getTCE = this.getTCE.bind(this);
  }
  ...
  getTCE = () => {
    fetch('http://192.168.0.7:3000/tce/', {
        method: 'GET'
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Text style={styles.title}>The Circuit - East</Text>
        <TextInput
